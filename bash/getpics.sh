...
#it downloads a tar file of pictures to our directory and if its already there then it assumes you're online
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz


#unpack the tar file if it is there, then deletes the local copy of the zip file
test -f ~/Pictures/pics.tgz && tar -xzf  ~/Pictures -C  ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
